...
const testResultMap: Record<TestType, TestResultData> = {
  IAP: { text: '내 친구는 나...', image: IAPImg.src },
  IAJ: { text: '호로록~ 아 좋다~', image: IAJImg.src },
  IHJ: { text: '이것 뭐에요?', image: IHJImg.src },
  IHP: { text: '여기어때 저기어때!', image: IHPImg.src },
  EAJ: { text: '저희,, 산책하실래요?', image: EAJImg.src },
  EAP: { text: '스님과 춤 춰 .', image: EAPImg.src },
  EHJ: { text: '이리로 오라', image: EHJImg.src },
  EHP: { text: '지금 템스가 끌려', image: EHPImg.src },
};
